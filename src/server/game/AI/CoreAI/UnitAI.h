...
TRINITY_GAME_API struct DefaultTargetSelector : public std::unary_function<Unit*, bool>
{
    const Unit* me;
    float m_dist;
    bool m_playerOnly;
...
TRINITY_GAME_API struct SpellTargetSelector : public std::unary_function<Unit*, bool>
{
    public:
...
TRINITY_GAME_API struct NonTankTargetSelector : public std::unary_function<Unit*, bool>
{
    public:
...
TRINITY_GAME_API class PlayerAI : public UnitAI
{
    protected:
        Player* const me;
    public:
...
TRINITY_GAME_API class SimpleCharmedAI : public PlayerAI
{
    public:
