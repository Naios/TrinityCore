...
TRINITY_GAME_API class SummonList
{
public:
...
TRINITY_GAME_API class EntryCheckPredicate
{
    public:
...
TRINITY_GAME_API class DummyEntryCheckPredicate
{
    public:
        bool operator()(ObjectGuid) { return true; }
};

TRINITY_GAME_API struct ScriptedAI : public CreatureAI
{
...
TRINITY_GAME_API class BossAI : public ScriptedAI
{
    public:
...
TRINITY_GAME_API class WorldBossAI : public ScriptedAI
{
    public:
