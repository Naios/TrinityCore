...
std::string TRINITY_GAME_API ConcatenateDungeons(LfgDungeonSet const& dungeons);
std::string TRINITY_GAME_API GetRolesString(uint8 roles);
std::string TRINITY_GAME_API GetStateString(LfgState state);
