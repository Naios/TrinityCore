...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        {
            { "add",            false, &HandleTeleAddCommand,             "", NULL },
            { "del",            true,  &HandleTeleDelCommand,             "", NULL },
            { "name",           true,  &HandleTeleNameCommand,            "", NULL },
            { "group",          false, &HandleTeleGroupCommand,           "", NULL },
            { "",               false, &HandleTeleCommand,                "", NULL },
            { NULL,             0,                  false, NULL,                              "", NULL }
        };
        static ChatCommand commandTable[] =
        {
            { "tele",           false, NULL,                   "", teleCommandTable },
