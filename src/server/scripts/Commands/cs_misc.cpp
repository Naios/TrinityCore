...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        {
            { "leader",                 false,  &HandleGroupLeaderCommand,          "", NULL },
            { "disband",                false,  &HandleGroupDisbandCommand,         "", NULL },
            { "remove",                 false,  &HandleGroupRemoveCommand,          "", NULL },
            { NULL,             0,                          false,  NULL,                               "", NULL }
        };
        static ChatCommand petCommandTable[] =
        {
            { "create",                 false, &HandleCreatePetCommand,             "", NULL },
            { "learn",                  false, &HandlePetLearnCommand,              "", NULL },
            { "unlearn",                false, &HandlePetUnlearnCommand,            "", NULL },
            { NULL,                 0,                      false, NULL,                                "", NULL }
        };
        static ChatCommand sendCommandTable[] =
        {
            { "items",                  true,  &HandleSendItemsCommand,             "", NULL },
            { "mail",                   true,  &HandleSendMailCommand,              "", NULL },
            { "message",                true,  &HandleSendMessageCommand,           "", NULL },
            { "money",                  true,  &HandleSendMoneyCommand,             "", NULL },
            { NULL,                 0,                      false, NULL,                                "", NULL }
        };
        static ChatCommand commandTable[] =
        {
            { "dev",                    false, &HandleDevCommand,                   "", NULL },
            { "gps",                    false, &HandleGPSCommand,                   "", NULL },
            { "aura",                   false, &HandleAuraCommand,                  "", NULL },
            { "unaura",                 false, &HandleUnAuraCommand,                "", NULL },
            { "appear",                 false, &HandleAppearCommand,                "", NULL },
            { "summon",                 false, &HandleSummonCommand,                "", NULL },
            { "groupsummon",            false, &HandleGroupSummonCommand,           "", NULL },
            { "commands",               true,  &HandleCommandsCommand,              "", NULL },
            { "die",                    false, &HandleDieCommand,                   "", NULL },
            { "revive",                 true,  &HandleReviveCommand,                "", NULL },
            { "dismount",               false, &HandleDismountCommand,              "", NULL },
            { "guid",                   false, &HandleGUIDCommand,                  "", NULL },
            { "help",                   true,  &HandleHelpCommand,                  "", NULL },
            { "itemmove",               false, &HandleItemMoveCommand,              "", NULL },
            { "cooldown",               false, &HandleCooldownCommand,              "", NULL },
            { "distance",               false, &HandleGetDistanceCommand,           "", NULL },
            { "recall",                 false, &HandleRecallCommand,                "", NULL },
            { "save",                   false, &HandleSaveCommand,                  "", NULL },
            { "saveall",                true,  &HandleSaveAllCommand,               "", NULL },
            { "kick",                   true,  &HandleKickPlayerCommand,            "", NULL },
            { "unstuck",                true,  &HandleUnstuckCommand,               "", NULL },
            { "linkgrave",              false, &HandleLinkGraveCommand,             "", NULL },
            { "neargrave",              false, &HandleNearGraveCommand,             "", NULL },
            { "showarea",               false, &HandleShowAreaCommand,              "", NULL },
            { "hidearea",               false, &HandleHideAreaCommand,              "", NULL },
            { "additem",                false, &HandleAddItemCommand,               "", NULL },
            { "additemset",             false, &HandleAddItemSetCommand,            "", NULL },
            { "bank",                   false, &HandleBankCommand,                  "", NULL },
            { "wchange",                false, &HandleChangeWeather,                "", NULL },
            { "maxskill",               false, &HandleMaxSkillCommand,              "", NULL },
            { "setskill",               false, &HandleSetSkillCommand,              "", NULL },
            { "pinfo",                  true,  &HandlePInfoCommand,                 "", NULL },
            { "respawn",                false, &HandleRespawnCommand,               "", NULL },
            { "send",                   true,  NULL,                                "", sendCommandTable },
            { "pet",                    false, NULL,                                "", petCommandTable },
            { "mute",                   true,  &HandleMuteCommand,                  "", NULL },
            { "unmute",                 true,  &HandleUnmuteCommand,                "", NULL },
            { "movegens",               false, &HandleMovegensCommand,              "", NULL },
            { "cometome",               false, &HandleComeToMeCommand,              "", NULL },
            { "damage",                 false, &HandleDamageCommand,                "", NULL },
            { "combatstop",             true,  &HandleCombatStopCommand,            "", NULL },
            { "flusharenapoints",       false, &HandleFlushArenaPointsCommand,      "", NULL },
            { "repairitems",            true,  &HandleRepairitemsCommand,           "", NULL },
            { "freeze",                 false, &HandleFreezeCommand,                "", NULL },
            { "unfreeze",               false, &HandleUnFreezeCommand,              "", NULL },
            { "listfreeze",             false, &HandleListFreezeCommand,            "", NULL },
            { "group",                  false, NULL,                                "", groupCommandTable },
            { "possess",                false, HandlePossessCommand,                "", NULL },
            { "unpossess",              false, HandleUnPossessCommand,              "", NULL },
            { "bindsight",              false, HandleBindSightCommand,              "", NULL },
            { "unbindsight",            false, HandleUnbindSightCommand,            "", NULL },
            { "playall",                false, HandlePlayAllCommand,                "", NULL },
            { NULL,                 0,                      false, NULL,                                "", NULL }
        };
        return commandTable;
    }
