...
foreach(SCRIPT_MODULE_PATH ${SCRIPT_PROJECTS})
  if(IS_DIRECTORY "${CMAKE_SOURCE_DIR}/src/server/scripts/${SCRIPT_MODULE_PATH}")
    ...
    file(STRINGS "${CMAKE_SOURCE_DIR}/src/server/scripts/${SCRIPT_MODULE_PATH}/defaults" defaults_list NEWLINE_CONSUME)
    string(REPLACE "\n" ";" defaults_list ${defaults_list}])

    if (SCRIPTS EQUAL 0)
     list(GET defaults_list 4 default_value)
    else()
     list(GET defaults_list 3 default_value)
    endif()

    if (NOT default_value)
      message(FATAL_ERROR "Invalid defaults file for script project ${CMAKE_SOURCE_DIR}/src/server/scripts/${SCRIPT_MODULE_PATH}")
    endif()
